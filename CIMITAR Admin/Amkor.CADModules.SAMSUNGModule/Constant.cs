...
namespace Amkor.CADModules.SAMSUNGModule
{
	...
	public class Constant
	{
		...
		public class GridYield
		{
			...
			public const int TestProgram = 6;

			// Token: 0x04000011 RID: 17
			public const int StartTime = 7;

			// Token: 0x04000012 RID: 18
			public const int EndTime = 8;

			// Token: 0x04000013 RID: 19
			public const int Input = 9;

			// Token: 0x04000014 RID: 20
			public const int PASS_Final = 10;

			// Token: 0x04000015 RID: 21
			public const int FAIL_Final = 11;

			// Token: 0x04000016 RID: 22
			public const int Yield = 12;

			// Token: 0x04000017 RID: 23
			public const int PASS_1st = 13;

			// Token: 0x04000018 RID: 24
			public const int FAIL_1st = 14;

			// Token: 0x04000019 RID: 25
			public const int FPY = 15;

			// Token: 0x0400001A RID: 26
			public const int RetestRate = 16;

			// Token: 0x0400001B RID: 27
			public const int MaxColumn = 17;
		}
