...
class QTIMTBAParsing(BaseApp):
    ...
    def add_event_error(self, path_file = r"\JAM_list\QTI\QTI_Jam_list.xlsx"):
    ...
    def load_error_dict(self, file_path="QTI_error_dict.txt"):
    ...
    def create_query(self, stack): 
        ...
        for machine_name, mnbr, datetime_event_str, id_error in stack:
            ...
            # datetime_str = datetime_event_str.strftime("%Y-%m-%d %H:%M:%S")
