...
def filter_folder(source_path, rel_test_folder):
    ...
    for folder in rel_test_folder:
        ...
        # if folder == 'REL_870ea-RELSLT1-1FT1':
...
def main():
    ...
    source_path = r"\\10.201.21.12\esicifsp\v1esisltn\DATA\TelosE\Manual_DATA"     #Window
    # source_path = r"/mnt/esi_siplet/DATA/TelosE/Manual_DATA"     #Linux
    try:
