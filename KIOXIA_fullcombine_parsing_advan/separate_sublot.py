...
if __name__ == "__main__":
    ...
    # generate_asc_file(in_asc_file_path="C:/Code/KIOXIA/737/results/FCL_asc",
    #                 out_asc_file_path="C:/Code/KIOXIA/737/asc_processed")
    
    generate_asc_file(in_asc_file_path="/kiomagd/737/Full_Lot_Combine_result_file/Fullcombinelot",
                      out_asc_file_path="/kiomagd/737/Full_Lot_Combine_result_file/Fullcombinelot/Separate_Sublot")
