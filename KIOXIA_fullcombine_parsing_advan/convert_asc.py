...
def check_tester_status( endtime, machine):
    data_list = [endtime, machine]
    status = stored_procedure.check_testing_status(data_list)
    print(status)
...
def parsingData(sourcePath, inputFileCsv, outputDir):
    ...
    # check_csv_file = check_csv_to_start(csv_path, 30000)
    ...
    for tracecode in all_tracecode:
        existed_tracecode.append(tracecode)
...
def main():
    ...
    sourcepath = "/kiomagd/737/Full_Lot_Combine_result_file/Fullcombinelot/asc_result"
    inputFileCsv = "/kiomagd/737/FULL_TEST"
    outputFileAsc = "/kiomagd/737/Full_Lot_Combine_result_file/Fullcombinelot"

    # sourcepath = "C:/Code/KIOXIA/737/results/FCL_asc"
    # inputFileCsv = "C:/Code/KIOXIA/737/csv/temp"
    # outputFileAsc = "C:/Code/KIOXIA/737/asc_processed"
    ...
    parsingData(sourcepath, inputFileCsv, outputFileAsc)
    end_time = time.time()
